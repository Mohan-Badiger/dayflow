    ...
    <main className="min-h-screen bg-(--background) flex flex-col items-center justify-center p-4">
      <div className="max-w-4xl w-full space-y-16 text-center">
        ...
        <motion.div 
          ...
          className="space-y-6"
        >
          <div className="inline-block px-4 py-1.5 rounded-full bg-brand/10 text-brand font-semibold text-sm mb-4">
        ...
        >
          <div className="space-y-3 p-6 bg-surface-3 rounded-2xl">
            ...
            <h2 className="text-lg font-bold">Daily Hub</h2>
            <p className="text-slate-500 text-sm">Everything that matters today in one clean, beautiful dashboard.</p>
          </div>
          <div className="space-y-3 p-6 bg-surface-3 rounded-2xl">
            <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 text-brand flex items-center justify-center rounded-xl">
              <Target className="w-6 h-6" />
            </div>
            <h2 className="text-lg font-bold">Deep Work</h2>
