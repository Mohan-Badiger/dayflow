        ...
        <div className="w-full md:w-[42%] bg-[#f4f7f6] flex flex-col items-center py-12 px-8 relative border-l border-gray-100">
          ...
          <div className="w-full max-w-[260px] flex flex-col items-center justify-center flex-1">
            <button
              ...
              className="w-full bg-white text-gray-800 border border-gray-200 rounded-full h-[52px] px-5 flex items-center hover:bg-gray-50 hover:border-gray-300 hover:shadow-lg transition-all duration-300 group shadow-sm"
            >
            ...
            <div className="mt-6 text-[13px] text-gray-500 text-center w-full font-light tracking-wide">
              Are you new to DayFlow? <button onClick={() => signIn("google", { callbackUrl: "/today" })} className="text-[#2b7a6b] hover:text-[#1d5c50] font-medium transition-colors ml-1">Sign up.</button>
            </div>
          </div>
        </div>
